...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-full items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <div className="flex w-full max-w-3xl flex-col items-center justify-between py-32 pt-5 px-16 bg-white dark:bg-black sm:items-start">
        <div className="w-full mb-10 flex flex-row gap-2 items-center">
          <SearchElement />
        </div>
        <div className="w-full flex flex-row gap-2 items-center mb-10">
          <IconCard title="Latest Block" value={stats.latestBlock} />
          <IconCard title="Indexed Blocks" value={stats.indexedBlocks} />
          <IconCard title="Total Transactions" value={stats.totalTransactions} />
        </div>
